# Что такое Market Bot?

Market Bot - это автоматизированная торговая система с поддержкой множества стратегий (AI, Grid, Gates), множества брокеров и ML-анализа рынка.
...
2. **Новостной анализ**
   - LLM-анализ тональности (Ollama/Finance-Llama-8B)
